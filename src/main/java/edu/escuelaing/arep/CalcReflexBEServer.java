...
public class CalcReflexBEServer {
            ...
            while (true) {
                try (Socket clientSocket = serverSocket.accept();
                    ...
                    if (command != null) {
                        ...
                        List<Double> params = getParams(command);
    ...
    private static String executeOperation(String operation, List<Double> params)
    ...
    private static String executeMathOperation(String operation, List<Double> params)
            throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        Method method;
