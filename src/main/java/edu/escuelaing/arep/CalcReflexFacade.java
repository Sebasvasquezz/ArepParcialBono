...
public class CalcReflexFacade {
    ...
    public static String obtenerCliente() {
        ...
        + "<form>\n"
        + "<label for=\"comando\">Ingrese el Comando deseado ej: sin(30), bbl(50, 2, 6, 12, 5) :</label><br>\n"
        + "<input type=\"text\" id=\"comando\" name=\"comando\" placeholder=\"Comando (param1, ...):\"><br><br>\n"
